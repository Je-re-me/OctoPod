...
const TermsOfUse = () => (
  <div className="page-container">
    <div className="page-content" style={{ maxWidth: 800, margin: "0 auto" }}>
      <h1>Terms of Use</h1>
      <p>Welcome to OctoPod! By using our platform, you agree to the following terms:</p>
      <ul style={{ textAlign: "left", margin: "2rem auto", maxWidth: 700 }}>
        <li><strong>Legal Use:</strong> You agree to use OctoPod for lawful purposes only.</li>
        ...
        <li><strong>Liability:</strong> OctoPod is not liable for any damages resulting from misuse of the platform or uploaded content.</li>
